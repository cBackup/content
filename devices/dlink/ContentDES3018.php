 ...
 */
class ContentDES3018 extends ContentInstaller
{
    ...
    public function install()
    {
        ...
        if ($this->recordExists('{{%device}}', ['vendor'=> 'Dlink', 'model' => 'DES-3018'])) {
            throw new \Exception('Device Dlink DES-3018 already exists');
        }

        /** Insert new Device Dlink DES-3018  */
        ...
        $device = $this->getEntryIdentifier('{{%device}}', ['vendor'=> 'Dlink', 'model' => 'DES-3018'], 'id');

        /** Add device attributes */
        $this->command->batchInsert('{{%device_attributes}}', ['device_id', 'sysobject_id', 'hw', 'sys_description'], [
            [$device, '1.3.6.1.4.1.171.10.63.2', null, 'Dlink DES-3018 Fast Ethernet Switch'],
        ])->execute();
