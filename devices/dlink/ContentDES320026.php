...
class ContentDES320026 extends ContentInstaller
{
    ...
    public function install()
    {
        ...
        if ($this->recordExists('{{%device}}', ['vendor'=> 'Dlink', 'model' => 'DES_3200_26'])) {
            throw new \Exception('Device Dlink DES_3200_26 already exists');
        }

        /** Insert new Device Dlink DES_3200_26  */
        ...
        $device = $this->getEntryIdentifier('{{%device}}', ['vendor'=> 'Dlink', 'model' => 'DES_3200_26'], 'id');

        /** Add device attributes */
        $this->command->batchInsert('{{%device_attributes}}', ['device_id', 'sysobject_id', 'hw', 'sys_description'], [
            [$device, '1.3.6.1.4.1.171.10.113.1.5', 'A1', 'D-Link DES-3200-26 Fast Ethernet Switch'],
        ])->execute();
