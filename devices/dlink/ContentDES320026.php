...
class ContentDES320026 extends ContentInstaller
{
    ...
    public function install()
    {
        ...
        if ($this->recordExists('{{%device}}', ['vendor'=> 'Dlink', 'model' => 'DES-3200-26'])) {
            throw new \Exception('Device Dlink DES-3200-26 already exists');
        }

        /** Insert new Device Dlink DES-3200-26  */
        ...
        $device = $this->getEntryIdentifier('{{%device}}', ['vendor'=> 'Dlink', 'model' => 'DES-3200-26'], 'id');
