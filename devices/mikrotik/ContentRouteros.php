 ...
 */
class ContentRouteros extends ContentInstaller
{
    ...
    public function install()
    {
        ...
        /** Insert new Device Mikrotik RouterOS  */
        ...
        $device = $this->getEntryIdentifier('{{%device}}', ['vendor'=> 'Mikrotik', 'model' => 'RouterOS'], 'id');

        /** Add device attributes */
        $this->command->batchInsert('{{%device_attributes}}', ['device_id', 'sysobject_id', 'hw', 'sys_description'], [
            [$device, '1.3.6.1.4.1.14988.1', null, 'router']
        ])->execute();
