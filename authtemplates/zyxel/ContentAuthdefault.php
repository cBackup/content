...
namespace app\modules\cds\content\authtemplates\zyxel;

use app\modules\cds\components\ContentInstaller;

/**
 * @package app\modules\cds\content\authtemplates\zyxel
 */
class ContentAuthdefault extends ContentInstaller
{
    ...
    public function install()
    {
        ...
        if ($this->recordExists('{{%device_auth_template}}', ['name' => 'zyxel_auth'])) {
            throw new \Exception('Auth template zyxel_auth already exists');
        }
