...
namespace app\modules\cds\content\authtemplates\zte;

use app\modules\cds\components\ContentInstaller;

/**
 * @package app\modules\cds\content\authtemplates\zte
 */
class ContentAuthdefault extends ContentInstaller
{
    ...
    public function install()
    {
        ...
        if ($this->recordExists('{{%device_auth_template}}', ['name' => 'zte_auth'])) {
            throw new \Exception('Auth template zte_auth already exists');
        }
